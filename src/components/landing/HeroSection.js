...
export default function HeroSection() {
  return (
    <section id="platform-overview" className="relative w-full py-12 sm:py-16 md:py-20 px-6 sm:px-10 lg:px-16 bg-[#FAFAFC] text-slate-900 overflow-hidden flex flex-col justify-between border-b border-slate-200/60">
      ...
      >
        ...
        >
          <div className="space-y-3 pt-1">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-red-50 border border-red-200/80 text-[#D8331F] text-xs font-bold shadow-2xs">
              <span className="w-2 h-2 rounded-full bg-[#D8331F] animate-pulse" />
              <span>100% White-Label Shipping Technology</span>
            </div>
            <h1 className="font-sans font-extrabold text-3xl sm:text-4xl md:text-5xl lg:text-[3.2rem] leading-[1.08] tracking-tight">
              <span className="text-slate-900 block">Build your brand.</span>
              <span className="text-[#D8331F] block">Own your customers.</span>
          ...
          <div className="flex flex-wrap gap-2.5 font-sans text-xs">
            <span className="bg-slate-100/80 border border-slate-200/80 px-3.5 py-1.5 rounded-full text-slate-800 font-bold shadow-2xs">
              🌐 Your Domain & Colors
            </span>
            <span className="bg-red-50 border border-red-200/80 px-3.5 py-1.5 rounded-full text-[#D8331F] font-bold shadow-2xs">
              ⚡ 100% Margin Control
            </span>
            <span className="bg-emerald-50 border border-emerald-200/80 px-3.5 py-1.5 rounded-full text-emerald-700 font-bold shadow-2xs">
              🔌 14+ Courier APIs
            </span>
          </div>
